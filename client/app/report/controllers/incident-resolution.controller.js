...
.controller('ResolutionReportCtrl', function ($scope, $http, $location, $window, socket, Auth) {
    ...
    anychart.onDocumentReady(function() {
        ...
        /*
        $http.get('/api/issues/prioritisation/5923ea094632f26f5d77bf5f').success(function(issues) {
            data = issues;
            // create the chart
    ...
    $scope.data = [];
        ...
        $http.get('/api/issues/' + '5923ea094632f26f5d77bf5f' + '/statuses' ).success(function(issues) {
                   $scope.issues = issues;
    ...
    $scope.isOverSLA = function (dateCaptured, sla, issue) {
